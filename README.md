...
**⚠️ This is development branch, not intended to be usedd publicly. To host the bot use [production](https://github.com/ZiRO-Bot/Z3R0/tree/overhaul) branch instead**

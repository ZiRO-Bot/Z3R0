...
class ZEmbedBuilder:
    ...
    def setFooter(self, text: locale_str | str, iconUrl: str) -> ZEmbedBuilder:
    ...
    async def build(self, context: Context, *, cls=discord.Embed, autoGenerateDT: bool = False) -> discord.Embed:
        kwargs = {}
